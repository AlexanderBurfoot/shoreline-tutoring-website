...
const bundlePricing: PricingRow[] = [
    { yearLevel: 'Year 1 – Year 6 / Selective High School / Opportunity Classes', price: '$2,400' },
    { yearLevel: 'Year 7 – Year 8', price: '$2,600' },
    { yearLevel: 'Year 9 – Year 10', price: '$2,600' },
    { yearLevel: 'Year 11', price: '$2,800' },
    { yearLevel: 'Year 12', price: '$3,000' },
];

const hourlyPricing: PricingRow[] = [
    { yearLevel: 'Year 1 – Year 6 / Selective High School / Opportunity Classes', price: '$130' },
    { yearLevel: 'Year 7 – Year 8', price: '$140' },
    { yearLevel: 'Year 9 – Year 10', price: '$140' },
    { yearLevel: 'Year 11', price: '$150' },
    { yearLevel: 'Year 12', price: '$160' },
];
